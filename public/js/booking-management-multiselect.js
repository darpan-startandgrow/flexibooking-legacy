...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div id="ms-list-'+ instance.listNumber +'" class="ms-options-wrap"><button type="button" class="textbox"><span>None Selected</span></button><div class="ms-options no-tooltip"><ul></ul></div></div>');
