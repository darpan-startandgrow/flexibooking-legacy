...
<div class="timeslot-calendar-container">
  ...
  <div class="calendarinnercontent">
    ...
    <div id="timeslot_calendar" class="services-calendar-box" style="position: relative;"></div>
  </div>
...
<div id="extra_service_modal" class="modaloverlay">
    <div class="modal animate__animated animate__jello">
        <span class="close" onclick="closeModal('extra_service_modal')">&times;</span>
...
<script>
    window.bmTimeslotCalendarConfig = {
        timeslotInitialStart: '<?php echo $now->format( 'Y-m-d' ); ?>',
        timeslotInitialEnd: '<?php echo $end_date_obj->format( 'Y-m-d' ); ?>',
        timeslotevents: <?php echo $calendar_events_json; ?>,
        cat_ids: '<?php echo isset( $cat_ids ) ? $cat_ids : ''; ?>'
    };
</script>
