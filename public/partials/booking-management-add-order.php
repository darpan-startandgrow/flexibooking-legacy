...
if ( filter_input( INPUT_POST, 'savefrontorder' ) ) {
                            ...
                            if ( ( $bookable_extra == false ) ) {
                                ...
                                if ( isset( $slot_info['slot_capacity_left_after_booking'] ) && isset( $slot_info['slot_min_cap'] ) && ( $slot_info['slot_capacity_left_after_booking'] >= 0 ) && ( $total_service_booked % $slot_info['slot_min_cap'] == 0 ) ) {
                                    ...
                                    if ( isset( $booking_id ) && !empty( $booking_id ) ) {
                                        ...
                                        if ( $payment_id > 0 ) {
                                            if ( !is_admin() ) {
                                                $ga_purchase_data = apply_filters( 'flexibooking_google_analytics_data', $booking_key );
                                                if ( $ga_purchase_data ) {
                                                    ?>
                                                    <script>
                                            ...
                                            if ( is_admin() ) {
                                                ...
                                                $redirect_url = add_query_arg( 'booking_success', $booking_key, wp_get_referer() );
                                            }
...
<div class="wrap">
    <form role="form" method="post" id="order_form">
        ...
        <table class="form-table sg-add-order-content-table" role="presentation" id="order_table">
            ...
            <tr>
                ...
                <td class="bminput bm_order_field_required">
                    <select name="service_category" id="service_category" class="regular-text" onchange="bm_fetch_bookable_services(this.value)" required>
            ...
            <tr>
                ...
                <td class="bminput bm_order_field_required" id="bm_services_by_category" required>
            ...
            <tr>
                ...
                <td class="bminput bm_order_field_required" required>
            ...
            <tr class="price_module_data" <?php echo !empty( $id ) && isset( $price_module_data ) && !empty( $price_module_data ) ? '' : 'style="display :none;"'; ?>>
                ...
                <td>
                    <div class="price_module_discount_content">
                        <?php
        ...
        <div class="customer_details sg-add-order-customer_details">
                <div class="greybox1 billing_details" <?php echo $id == 0 ? 'style="display :none;"' : ''; ?> id="billing_details">
                
                <h1><?php esc_html_e( 'Billing Details', 'service-booking' ); ?></h1>
                ...
                <h1 class="shipping_detail_heading"><?php esc_html_e( 'Shipping Details', 'service-booking' ); ?>
             ...
             <div class="row">
                        ...
                        <input type="submit" name="savefrontorder" id="savefrontorder" class="button button-primary" value="<?php $id == 0 ? esc_attr_e( 'Save', 'service-booking' ) : esc_attr_e( 'Update', 'service-booking' ); ?>">
