...
class FontMetrics
{
    ...
    public function loadFontFamilies()
    {
        ...
        $cacheDataClosure = include $this->getCacheFile();
    ...
    public function registerFont($style, $remoteFile, $context=null)
    {
        ...
        [
            ...
            $baseHost,
            $basePath,
        ] = Helpers::explode_url($remoteFile);
    ...
    public function getType($type)
    {
        if (preg_match('/bold/i', $type)) {
            $weight = 700;
        } else if (preg_match('/([1-9]00)/', $type, $match)) {
            $weight = (int) $match[0];
        } else {
            $weight = 400;
        }
