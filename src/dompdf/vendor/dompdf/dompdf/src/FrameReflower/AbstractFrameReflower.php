...
abstract class AbstractFrameReflower
{
        ...
        case "absolute":
            ...
            if ($parent !== $frame->get_root()) {
                ...
                if ($parent_style->height === "auto") {
                    ...
                    $containing_block_height = ($parent_containing_block["h"] - (float) $parent_style->length_in_pt(
                        [
    ...
    }//end determine_absolute_containing_block()
    ...
    }//end _get_collapsed_margin_length()
    ...
    function get_min_max_width(): array
    {
        ...
        [
            $min,
            $max,
        ] = $this->get_min_max_content_width();
