...
class Block extends AbstractFrameReflower
{
    ...
    }//end _calculate_restricted_width()
        ...
        if ($frame->is_absolute()) {
            ...
            if ($height === "auto" || $top === "auto" || $bottom === "auto") {
                ...
                if ($diff >= 0) {
                    ...
                    } else if ($margin_top === "auto") {
                        $margin_top = $diff;
                    } else if ($margin_bottom === "auto") {
                        $margin_bottom = $diff;
                    }
                } else {
    ...
    }//end _calculate_restricted_height()
