...
class Image extends AbstractFrameReflower
{
    ...
    function get_min_max_width(): array
    {
        ...
        if ($this->get_dompdf()->getOptions()->getDebugPng()) {
            ...
            print "get_min_max_width() ".$frame->get_style()->width.' '.$frame->get_style()->height.';'.$frame->get_parent()->get_style()->width." ".$frame->get_parent()->get_style()->height.";".$frame->get_parent()->get_parent()->get_style()->width.' '.$frame->get_parent()->get_parent()->get_style()->height.';'.$img_width.' '.$img_height.'|';
        }
