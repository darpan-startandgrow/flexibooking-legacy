...
class Text extends AbstractFrameReflower
{
    ...
    function get_min_max_width(): array
    {
        ...
        case "pre-line":
            ...
            array_walk(
                $words,
                function (&$chunked_text_width, $chunked_text) use ($fontMetrics, $font, $size, $word_spacing, $char_spacing) {
        ...
        return $this->_min_max_cache = [
            $min, $max, $min_word, "min" => $min, "max" => $max, 'min_word' => $min_word
        ];
