...
EOT;
    ...
    }//end o_embedded_file_dictionary()
    ...
    private function openFont($font)
    {
        ...
        if (file_exists($fontcache.'/'.$cache_name)) {
            ...
            $this->fonts[$font] = include $fontcache.'/'.$cache_name;
        ...
        if (!isset($this->fonts[$fontName])) {
            ...
            if (isset($this->fonts[$fontName])) {
                ...
                if (file_exists("$fontName.ttf")) {
                    ...
                    $fileSuffix = 'TTF';
                } else if (file_exists("$fontName.pfb")) {
                    $fileSuffix = 'pfb';
                } else if (file_exists("$fontName.PFB")) {
                    $fileSuffix = 'PFB';
                } else {
    ...
    function setLineTransparency($mode, $opacity)
    {
        ...
        if ($mode === (key_exists('mode', $this->currentLineTransparency) ? $this->currentLineTransparency['mode'] : '')
            && $opacity === (key_exists('opacity', $this->currentLineTransparency) ? $this->currentLineTransparency["opacity"] : '')
        ) {
            return;
        }
    ...
    function setFillTransparency($mode, $opacity)
    {
        ...
        if ($mode === (key_exists('mode', $this->currentFillTransparency) ? $this->currentFillTransparency['mode'] : '')
            && $opacity === (key_exists('opacity', $this->currentFillTransparency) ? $this->currentFillTransparency["opacity"] : '')
        ) {
            return;
        }
